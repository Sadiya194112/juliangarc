...
from apps.Stripe.views import create_host_payout, setup_stripe_connect, get_host_payouts, get_user_payments, stripe_webhook, payment_success, payment_cancel, stripe_onboarding_refresh, stripe_onboarding_return, host_withdraw_now, host_earnings_and_payouts, remove_stripe_account
...
urlpatterns = [
    ...
    path('remove-stripe-account/', remove_stripe_account, name='remove-stripe-account'),
